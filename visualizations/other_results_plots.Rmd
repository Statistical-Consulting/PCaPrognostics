...
plot1 <- ggplot(
  ...
  scale_x_discrete(
    labels = c(
      ...
      "pData + Block Data" = "Block Data + Clin. Data",
      "pData_AutoEncoder" = "Autoencoder + Clin. Data",
      "Imputed"            = "Common",
      "pData_Imputed"      = "Common + Clin. Data",
      "Intersection"         = "Intersect.",
      "pData_Intersection"   = "Intersect. + Clin. Data",
      "Pathway Data"          = "Pathway Data + Clin. Data",
      "pData"             = "Clin. Data"
    )
  ) +
  scale_color_manual(values = model_colors) +  # Apply manual color scale
  labs(
